# Contributing to hubVis

This outlines how to propose a change to `hubVis`. For more general info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubVis", fork = TRUE)`.
...
Please note that the hubVis project is released with a [Contributor Code
of
