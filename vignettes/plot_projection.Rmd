...
we will use the examples data from the [hubExamples](https://github.com/Infectious-Disease-Modeling-Hubs/hubExamples) package. 
...
```{r f_p}
# Pre-filtering
forecast_quantile <- as_model_out_tbl(forecast_quantile)
...
specific column. This feature is currently only available for "static" plot. 
...
plot_step_ahead_model_output(forecast_quantile, forecast_target,
                             ...
                             use_median_as_point = TRUE,
                             x_col_name = "target_end_date",
                             facet = "location", interactive = FALSE,
