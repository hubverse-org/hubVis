...
test_that("Input parameters", {
  ...
  # Column
  expect_error(plot_step_ahead_model_output(projection_data_a_us, truth_data_us,
                                            x_col_name = "date"))
  expect_error(plot_step_ahead_model_output(projection_data_a_us, truth_data_us,
                                            fill_by = "model_name"))
  df_test <- dplyr::rename(projection_data_a_us, type_id = output_type_id)
  expect_error(plot_step_ahead_model_output(df_test, truth_data_us))
  ...
  expect_no_error(plot_step_ahead_model_output(df_test, truth_data_us))
  ...
  expect_warning(plot_step_ahead_model_output(d_proj, truth_data_us))
  expect_no_error(plot_step_ahead_model_output(d_proj, truth_data_us,
                                               intervals = 0.5))
...
test_that("Output", {
  ...
  # Invisible
  expect_invisible(plot_step_ahead_model_output(projection_data, truth_data_us,
                                                show_plot = FALSE))
  ...
  plot_test <-
    plot_step_ahead_model_output(dplyr::filter(projection_data_a_us,
                                 ...
                                 truth_data_us, interactive = FALSE,
  ...
  plot_test <-
    plot_step_ahead_model_output(projection_data, truth_data_us,
                                 ...
                                 plot_truth = FALSE, ens_color = "black",
  ...
  plot_test <-
    plot_step_ahead_model_output(projection_data,
                                 dplyr::mutate(truth_data_us,
                                               scenario_id = "A-2021-03-05"),
                                 facet = "scenario_id", plot_truth = TRUE,
                                 facet_scales = "free",
                                 show_legend = FALSE,
                                 use_median_as_point = TRUE)
  ...
  plot_test <-
    plot_step_ahead_model_output(projection_data, truth_data_us,
                                 top_layer = "truth", facet = "model_id",
                                 fill_by = "scenario_id",
  ...
  plot_test <- plot_step_ahead_model_output(projection_data_a_us, truth_data_us,
                                            intervals = 0.9,
                                            ens_color = "black",
                                            ens_name = "hub-ensemble",
                                            facet = "model_id")
