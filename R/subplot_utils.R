...
plotly_facet_data <- function(data, facet, facet_value, intervals) {
...
plotly_facet_plot <- function(plot_model, all_plot, all_ens, facet, facet_value,
                              all_facet_value, plot_target, target_data,
                              intervals, top_layer = top_layer,
                              fill_transparency = fill_transparency,
                              fill_by = fill_by, x_col_name = x_col_name,
                              x_target_col_name = x_target_col_name,
                              group = group, ens_name = ens_name,
                              ens_color = ens_color) {
  # Data
...
plotly_facet_layout <- function(plot_model, text, facet_title) {
...
plotly_facet <- function(facet_value, plot_model, all_plot, all_ens, facet,
                         ...
                         ens_color) {
  plot_model <-
    plotly_facet_plot(plot_model, all_plot, all_ens, facet, facet_value,
                      all_facet_value, plot_target, target_data, intervals,
                      fill_transparency = fill_transparency,
                      top_layer = top_layer, fill_by = fill_by,
                      x_col_name = x_col_name,
                      x_target_col_name = x_target_col_name,
                      group = group, ens_name = ens_name, ens_color)
...
plotly_subplot <- function(plot_model, all_plot, all_ens, facet,
                           all_facet_value, plot_target, target_data,
                           intervals, facet_value, facet_scales = facet_scales,
  ...
  subplot <- lapply(facet_value, plotly_facet, plot_model, all_plot, all_ens,
                    facet, all_facet_value, plot_target, target_data,
                    intervals, fill_transparency = fill_transparency,
                    top_layer = top_layer, facet_title = facet_title,
                    fill_by = fill_by, x_col_name = x_col_name,
                    x_target_col_name = x_target_col_name,
                    group = group, ens_name = ens_name,
...
simple_subplot <- function(plot_model, all_plot, all_ens, intervals,
                           plot_target, facet, target_data,
                           interactive = interactive,
                           fill_transparency = fill_transparency,
                           top_layer = top_layer, fill_by = fill_by,
                           x_col_name = x_col_name, facet_scales = facet_scales,
...
output_plot <-  function(
  ...
  if (!is.null(facet) && interactive) {
    plot_model <- plotly_subplot(plot_model, all_plot, all_ens, facet,
                                 facet_value, plot_target, target_data,
                                 intervals, facet_value,
    ...
    plot_model <- simple_subplot(plot_model,
                                 all_plot, all_ens, intervals, plot_target,
                                 facet, target_data, interactive = interactive,
                                 fill_transparency = fill_transparency,
                                 top_layer = top_layer, fill_by = fill_by,
                                 x_col_name = x_col_name,
                                 facet_scales = facet_scales,
